...
public class ProductoAnadido extends DomainEvent {
    private final ProductoId productoId;
    private final Procedencia procedencia;
    private final Informacion informacion;
    private final Precio precio;

    public ProductoAnadido(ProductoId productoId, Procedencia procedencia, Informacion informacion, Precio precio) {
        super("productoanadido");
